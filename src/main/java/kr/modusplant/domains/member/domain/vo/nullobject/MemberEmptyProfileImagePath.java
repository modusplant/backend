...
public class MemberEmptyProfileImagePath extends MemberProfileImagePath {

    public static MemberEmptyProfileImagePath create() {
        return new MemberEmptyProfileImagePath();
    }
