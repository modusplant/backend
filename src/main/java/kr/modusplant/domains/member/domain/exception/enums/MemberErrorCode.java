...
public enum MemberErrorCode implements ResponseCode {
    ...
    INCORRECT_MEMBER_ID(HttpStatus.BAD_REQUEST, "incorrect_member_id", "올바르지 않은 회원 ID를 사용하고 있습니다. "),
    INVALID_MEMBER_PROFILE_IMAGE_PATH(HttpStatus.BAD_REQUEST, "invalid_member_profile_image_path", "회원 프로필 이미지 경로의 서식이 올바르지 않습니다. "),
