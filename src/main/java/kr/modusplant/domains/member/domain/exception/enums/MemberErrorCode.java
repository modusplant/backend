...
public enum MemberErrorCode implements ResponseCode {
    ...
    ALREADY_LIKED(HttpStatus.BAD_REQUEST, "already_liked", "이미 해당 회원이 대상 게시글에 좋아요를 눌렀습니다. "),
    ALREADY_UNLIKED(HttpStatus.BAD_REQUEST, "already_unliked", "이미 해당 회원이 대상 게시글에 누른 좋아요를 취소했습니다. ");
