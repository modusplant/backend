...
public enum MemberErrorCode implements ErrorCode {
    ...
    EMPTY_REPORT_CONTENT(HttpStatus.BAD_REQUEST.value(), "empty_report_content", "제보 문서 컨텐츠가 비어 있습니다. "),
    EMPTY_REPORT_IMAGE_BYTES(HttpStatus.BAD_REQUEST.value(), "empty_report_image_bytes", "제보 문서 이미지 바이트 값이 비어 있습니다. "),
    EMPTY_REPORT_IMAGE_PATH(HttpStatus.BAD_REQUEST.value(), "empty_report_image_path", "제보 문서 이미지 경로가 비어 있습니다. "),
    EMPTY_REPORT_TITLE(HttpStatus.BAD_REQUEST.value(), "empty_report_title", "제보 문서 제목이 비어 있습니다. "),
    ...
    INVALID_REPORT_IMAGE_PATH(HttpStatus.BAD_REQUEST.value(), "invalid_report_image_path", "제보 문서 이미지 경로의 서식이 올바르지 않습니다. "),
    ...
    REPORT_CONTENT_OVER_LENGTH(HttpStatus.BAD_REQUEST.value(), "report_content_over_length", "제보 문서 컨텐츠가 허용되는 길이를 초과하였습니다. "),
    REPORT_TITLE_OVER_LENGTH(HttpStatus.BAD_REQUEST.value(), "report_title_over_length", "제보 문서 제목이 허용되는 길이를 초과하였습니다. "),
