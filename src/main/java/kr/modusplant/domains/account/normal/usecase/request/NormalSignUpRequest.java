package kr.modusplant.domains.account.normal.usecase.request;
...
public record NormalSignUpRequest(
        ...
        @Pattern(regexp = Regex.REGEX_VERSION, message = "동의한 개인정보처리방침 버전의 서식이 올바르지 않습니다.")
        ...
        @Pattern(regexp = Regex.REGEX_VERSION, message = "동의한 광고성 정보 수신 버전의 서식이 올바르지 않습니다.")
