...
public record SocialSignUpRequest(
        ...
        @Pattern(regexp = REGEX_NICKNAME, message = "닉네임은 2 ~ 16자까지 가능하며, 특수문자는 사용할 수 없습니다.")
        String nickname,
        ...
        @Pattern(regexp = REGEX_VERSION, message = "동의한 이용약관 버전의 서식이 올바르지 않습니다.")
        ...
        @Pattern(regexp = REGEX_VERSION, message = "동의한 개인정보처리방침 버전의 서식이 올바르지 않습니다.")
        ...
        @Pattern(regexp = REGEX_VERSION, message = "동의한 커뮤니티 운영정책 버전의 서식이 올바르지 않습니다.")
