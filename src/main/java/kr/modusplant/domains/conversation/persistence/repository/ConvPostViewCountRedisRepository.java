...
public class ConvPostViewCountRedisRepository {
    // viewCount::conv_post::{ulid}::view_count
    ...
    public Map<String, Long> findAll() {
        Set<String> keys = stringRedisTemplate.keys("viewCount::conv_post::*::view_count");
