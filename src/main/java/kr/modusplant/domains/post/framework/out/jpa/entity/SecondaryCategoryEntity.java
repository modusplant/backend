...
import static kr.modusplant.shared.persistence.vo.TableName.COMM_SECO_CATE;
...
public class SecondaryCategoryEntity {
    ...
    private SecondaryCategoryEntity(UUID uuid, String category, Integer order) {
        this.uuid = uuid;
        this.category = category;
        this.order = order;
    }
    ...
    public static final class CommCategoryEntityBuilder {
        ...
        public CommCategoryEntityBuilder commCategoryEntity(final SecondaryCategoryEntity commCategory) {
        ...
        public SecondaryCategoryEntity build() {
            return new SecondaryCategoryEntity(this.uuid, this.category, this.order);
        }
    }
}
