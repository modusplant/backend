...
public class AuthorEntity {
    ...
    private AuthorEntity(UUID uuid, String nickname, LocalDate birthDate, Boolean isActive, Boolean isDisabledByLinking, Boolean isBanned, Boolean isDeleted, LocalDateTime loggedInAt) {
        this.uuid = uuid;
    ...
    public static final class MemberEntityBuilder {
        ...
        public MemberEntityBuilder memberEntity(final AuthorEntity member) {
        ...
        public AuthorEntity build() {
            return new AuthorEntity(this.uuid, this.nickname, this.birthDate, this.isActive, this.isDisabledByLinking, this.isBanned, this.isDeleted, this.loggedInAt);
        }
    }
}