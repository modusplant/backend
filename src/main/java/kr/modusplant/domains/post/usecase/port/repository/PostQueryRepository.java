...
public interface PostQueryRepository {
    ...
    List<PostSummaryReadModel> findByKeywordWithCursor(SearchOption option, String keyword, SearchSort sort, Integer primaryCategoryId, List<Integer> secondaryCategoryIds, UUID currentMemberUuid, String cursorUlid, int size);
