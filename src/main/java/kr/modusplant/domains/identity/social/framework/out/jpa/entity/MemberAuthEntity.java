...
public class MemberAuthEntity {
    ...
    public void updateActiveMember(MemberEntity activeMember) {
    ...
    private MemberAuthEntity(MemberEntity originalMember, MemberEntity activeMember, String email, String pw, AuthProvider provider, String providerId, LocalDateTime lockoutUntil) {
    ...
    public static final class SiteMemberAuthEntityBuilder {
        ...
        public SiteMemberAuthEntityBuilder originalMember(final MemberEntity originalMember) {
            this.originalMember = originalMember;
            return this;
        }

        public SiteMemberAuthEntityBuilder activeMember(final MemberEntity activeMember) {
            this.activeMember = activeMember;
            return this;
        }
        ...
        public SiteMemberAuthEntityBuilder memberAuthEntity(final MemberAuthEntity memberAuth) {
        ...
        public MemberAuthEntity build() {
            return new MemberAuthEntity(this.originalMember, this.activeMember, this.email, this.pw, this.provider, this.providerId, this.lockoutUntil);
        }
    }
}
