...
@Repository
@Primary
public interface TipCategoryRepository extends UuidPrimaryKeyRepository<TipCategoryEntity>, CreatedAtRepository<TipCategoryEntity>, JpaRepository<TipCategoryEntity, Integer> {
