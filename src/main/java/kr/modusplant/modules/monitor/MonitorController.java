...
public class MonitorController {
    ...
    @Operation(
            summary = "성공적인 비즈니스 로직 실행",
            description = "비즈니스 로직을 정상적으로 실행합니다."
    )
    ...
    @Operation(
            summary = "Redis 헬퍼 실행",
            description = "Redis 저장소에 RedisHelper를 사용하여 저장합니다."
    )
