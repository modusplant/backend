...
@Repository
@Primary
public interface PropBugRepJpaRepository extends LastModifiedAtRepository<PropBugRepEntity>, SiteMemberUuidPrimaryKeyJpaRepository<PropBugRepEntity>, JpaRepository<PropBugRepEntity, UUID> {
}