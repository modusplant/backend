...
@Repository
public interface SiteMemberTermJpaRepository extends LastModifiedAtRepository<SiteMemberTermEntity>, UuidPrimaryKeyRepository<SiteMemberTermEntity>, JpaRepository<SiteMemberTermEntity, UUID> {
