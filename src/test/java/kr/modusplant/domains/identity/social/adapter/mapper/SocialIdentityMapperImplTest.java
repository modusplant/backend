...
import static kr.modusplant.domains.identity.social.common.constant.SocialStringConstant.*;
...
class SocialIdentityMapperImplTest {
    ...
    void testToSocialUserProfile_givenAuthProviderAndKakaoUserInfo_willReturnSocialUserProfile() {
        ...
        assertEquals(TEST_SOCIAL_KAKAO_EMAIL_STRING, result.getEmail().getEmail());
        assertEquals(TEST_SOCIAL_KAKAO_NICKNAME_STRING, result.getNickname().getNickname());
    ...
    void testToSocialUserProfile_givenAuthProviderAndGoogleUserInfo_willReturnSocialUserProfile() {
        ...
        assertEquals(TEST_SOCIAL_GOOGLE_EMAIL_STRING, result.getEmail().getEmail());
        assertEquals(TEST_SOCIAL_GOOGLE_NICKNAME_STRING, result.getNickname().getNickname());
