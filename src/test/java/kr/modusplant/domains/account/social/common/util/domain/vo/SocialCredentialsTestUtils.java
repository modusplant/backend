...
public interface SocialCredentialsTestUtils {
    ...
    SocialCredentials testBasicKakaoSocialCredentials = SocialCredentials.createBasicKakao(TEST_SOCIAL_KAKAO_PROVIDER_ID_STRING);
    SocialCredentials testBasicGoogleSocialCredentials = SocialCredentials.createBasicGoogle(TEST_SOCIAL_GOOGLE_PROVIDER_ID_STRING);
}
