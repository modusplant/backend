...
class TipPostViewCountRedisRepositoryTest {
    @Mock
    ...
    void readShoudReturnLongWhenValueExistsTest() {
        ...
        // when
        Long result = tipPostViewCountRedisRepository.read(ulid);
    ...
    void increaseTest() {
        ...
        // when
        Long result = tipPostViewCountRedisRepository.increase(ulid);
    ...
    void writeTest() {
        ...
        // when
        tipPostViewCountRedisRepository.write(ulid,20L);
    ...
    void findAllTest() {
        ...
        when(stringRedisTemplate.keys("viewCount::tip_post::*::view_count")).thenReturn(keys);
        ...
        // when
        Map<String, Long> result = tipPostViewCountRedisRepository.findAll();
