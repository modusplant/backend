...
import static kr.modusplant.domains.post.common.constant.PostJsonNodeConstant.TEST_POST_CONTENT_THUMBNAIL_FILENAME;
...
class PostMapperImplTest implements PostReadModelTestUtils {
    ...
    void testToPostDetailResponse_givenPostDetailModelAndContentAndViewCount_willReturnPostDetailResponse() {
        ...
        // when
        PostDetailResponse result = postMapper.toPostDetailResponse(TEST_PUBLISHED_POST_DETAIL_READ_MODEL, MEMBER_PROFILE_BASIC_USER_IMAGE_URL ,TEST_POST_CONTENT,viewCount);
    ...
    @Test
    @DisplayName("toPostDetailDataResponse PostDetailDataResponse 반환하기")
    void testToPostDetailDataResponse_givenPostDetailModelAndContentAndViewCount_willReturnPostDetailDataDataResponse() {
        // when
        PostDetailDataResponse result = postMapper.toPostDetailDataResponse(TEST_PUBLISHED_POST_DETAIL_DATA_READ_MODEL ,TEST_POST_CONTENT, TEST_POST_CONTENT_THUMBNAIL_FILENAME);
