...
public final class PostJsonNodeConstant {
    ...
    private static final String JSON_VIDEO_AND_FILE =
            "[{\"type\":\"video\",\"filename\":\"video_0.mp4\",\"order\":1,\"src\":\"/videos/2a7b8c9d-12e3-45f6-789a-bcde0123f456.mp4\"}," +
            "{\"type\":\"application\",\"filename\":\"file_0.pdf\",\"order\":2,\"src\":\"/files/59h16f67-5abc-48d2-95a1-9cb4e78c7890.pdf\"}]";

    private static final String JSON_PREVIEW =
            "[{\"type\":\"text\",\"data\":\"First text\"}," +
            "{\"type\":\"image\",\"src\":\"/images/16e94f67-5abc-48d2-95a1-9cb4e78c7890.jpg\"}]";
    ...
    public static final String TEST_POST_CONTENT_THUMBNAIL_KEY = "/images/16e94f67-5abc-48d2-95a1-9cb4e78c7890.jpg";
    public static final String TEST_POST_CONTENT_TEXT_AND_IMAGE_THUMBNAIL_KEY = "/images/16e94f67-5abc-48d2-95a1-9cb4e78c7890.jpg";
    public static final String TEST_POST_CONTENT_IMAGE_AND_VIDEO_THUMBNAIL_KEY = "/images/59h16f67-5abc-48d2-95a1-9cb4e78c7890.jpg";
    public static final String TEST_POST_CONTENT_PREVIEW_THUMBNAIL_KEY = "/images/16e94f67-5abc-48d2-95a1-9cb4e78c7890.jpg";

    // THUMBNAIL FILENAME String
    public static final String TEST_POST_CONTENT_THUMBNAIL_FILENAME = "image_0.jpg";
