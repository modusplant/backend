...
import kr.modusplant.domains.qna.persistence.repository.QnaPostViewCountRedisRepository;
...
class QnaPostViewCountRedisRepositoryTest {
    @Mock
    ...
    void readShoudReturnLongWhenValueExistsTest() {
        ...
        // when
        Long result = qnaPostViewCountRedisRepository.read(ulid);
    ...
    void increaseTest() {
        ...
        // when
        Long result = qnaPostViewCountRedisRepository.increase(ulid);
    ...
    void writeTest() {
        ...
        // when
        qnaPostViewCountRedisRepository.write(ulid,20L);
    ...
    void findAllTest() {
        ...
        when(stringRedisTemplate.keys("viewCount::qna_post::*::view_count")).thenReturn(keys);
        ...
        // when
        Map<String, Long> result = qnaPostViewCountRedisRepository.findAll();
