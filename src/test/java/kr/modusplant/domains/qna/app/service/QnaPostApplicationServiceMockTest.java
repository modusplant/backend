package kr.modusplant.domains.qna.app.service;
...
import kr.modusplant.domains.qna.persistence.repository.QnaPostViewLockRedisRepository;
...
class QnaPostApplicationServiceMockTest implements SiteMemberEntityTestUtils, PlantGroupEntityTestUtils, QnaPostEntityTestUtils {
    ...
    void countViewsShouldReturnRedisValueWhenRedisHasValueTest() {
        ...
        // when
        Long result = qnaPostApplicationService.countViews(ulid);
    ...
    void countViewsShouldThrowExceptionWhenRedisIsEmptyAndDbEmptyTest() {
        ...
        assertThrows(EntityNotFoundWithUlidException.class,
                () -> qnaPostApplicationService.countViews(ulid));
    }
    ...
    void increaseWhenLockExistsTest() {
        ...
        // when
        Long result = qnaPostApplicationService.increase(ulid,memberUuid);
