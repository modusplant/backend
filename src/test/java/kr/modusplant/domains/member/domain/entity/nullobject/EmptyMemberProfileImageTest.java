...
class EmptyMemberProfileImageTest {
    ...
    void testGetMemberProfileImagePath_givenNothing_willReturnEmptyMemberProfileImagePath() {
        assertThat(testEmptyMemberProfileImage.getMemberProfileImagePath()).isEqualTo(testEmptyMemberProfileImagePath);
    }
    ...
    void testGetMemberProfileImageBytes_givenNothing_willReturnEmptyMemberProfileImageBytes() {
        assertThat(testEmptyMemberProfileImage.getMemberProfileImageBytes()).isEqualTo(testEmptyMemberProfileImageBytes);
    }
}