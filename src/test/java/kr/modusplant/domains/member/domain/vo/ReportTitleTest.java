...
class ReportTitleTest {
    ...
    void testCreate_givenValidValue_willReturnReportTitle() {
        assertThat(ReportTitle.create(TEST_REPORT_TITLE)).isEqualTo(ReportTitle.create(TEST_REPORT_TITLE));
    }
    ...
    void testHashCode_givenSameObject_willReturnSameHashCode() {
        assertEquals(testReportTitle.hashCode(), testReportTitle.hashCode());
    }
}