...
class MemberProfileImagePathTest {
    ...
    void testEquals_givenObjectContainingDifferentProperty_willReturnFalse() {
        ...
        assertNotEquals(testMemberProfileImagePath, MemberProfileImagePath.create(String.format("member/%s/profile/%s", id, "image.png")));
    }

    @Test
    @DisplayName("같은 객체에 대한 hashcode 동일성 보장")
    void testHashCode_givenSameObject_willReturnSameHashCode() {
        assertEquals(testMemberProfileImagePath.hashCode(), testMemberProfileImagePath.hashCode());
    }
}