...
class ReportImageBytesTest {
    ...
    void testCreate_givenValidValue_willReturnReportImageBytes() {
        assertThat(ReportImageBytes.create(TEST_REPORT_IMAGE_BYTES_1)).isEqualTo(ReportImageBytes.create(TEST_REPORT_IMAGE_BYTES_1));
    }
    ...
    void testEquals_givenSameObject_willReturnTrue() {
        ...
        assertEquals(testReportImageBytes1, testReportImageBytes1);
    }
    ...
    void testEquals_givenObjectOfDifferentClass_willReturnFalse() {
        ...
        assertNotEquals(testReportImageBytes1, testMemberId);
    }

    @Test
    @DisplayName("다른 프로퍼티를 갖는 인스턴스에 대한 equals 호출")
    void testEquals_givenObjectContainingDifferentProperty_willReturnFalse() {
        assertNotEquals(testReportImageBytes1, ReportImageBytes.create((Arrays.toString(TEST_REPORT_IMAGE_BYTES_1) + "Test").getBytes()));
    }

    @Test
    @DisplayName("같은 객체에 대한 hashcode 동일성 보장")
    void testHashCode_givenSameObject_willReturnSameHashCode() {
        assertEquals(testReportImageBytes1.hashCode(), testReportImageBytes1.hashCode());
    }
}