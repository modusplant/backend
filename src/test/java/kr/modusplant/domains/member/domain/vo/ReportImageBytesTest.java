...
import static kr.modusplant.shared.persistence.common.util.constant.ReportConstant.TEST_REPORT_IMAGE_BYTES;
...
class ReportImageBytesTest {
    ...
    void testCreate_givenValidValue_willReturnReportImageBytes() {
        assertThat(ReportImageBytes.create(TEST_REPORT_IMAGE_BYTES)).isEqualTo(ReportImageBytes.create(TEST_REPORT_IMAGE_BYTES));
    }
    ...
    void testEquals_givenObjectContainingDifferentProperty_willReturnFalse() {
        assertNotEquals(testReportImageBytes, ReportImageBytes.create((Arrays.toString(TEST_REPORT_IMAGE_BYTES) + "Test").getBytes()));
    }

    @Test
    @DisplayName("같은 객체에 대한 hashcode 동일성 보장")
    void testHashCode_givenSameObject_willReturnSameHashCode() {
        assertEquals(testReportImageBytes.hashCode(), testReportImageBytes.hashCode());
    }
}