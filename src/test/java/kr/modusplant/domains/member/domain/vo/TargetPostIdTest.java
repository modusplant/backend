...
class TargetPostIdTest {
    ...
    void testEquals_givenObjectOfDifferentClass_willReturnFalse() {
        ...
        assertNotEquals(testTargetPostId, testMemberActiveStatus);
    }

    @Test
    @DisplayName("다른 프로퍼티를 갖는 인스턴스에 대한 equals 호출")
    void testEquals_givenObjectContainingDifferentProperty_willReturnFalse() {
        assertNotEquals(testTargetPostId, TargetPostId.create("01KM5WQTKHTTMTSXRSF43RW1P6"));
    }

    @Test
    @DisplayName("같은 객체에 대한 hashcode 동일성 보장")
    void testHashCode_givenSameObject_willReturnSameHashCode() {
        assertEquals(testTargetPostId.hashCode(), testTargetPostId.hashCode());
    }
}