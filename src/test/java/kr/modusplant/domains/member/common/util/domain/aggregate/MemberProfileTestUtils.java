...
public interface MemberProfileTestUtils {
    ...
    default MemberProfile createMemberProfileWithoutImage() {
        return MemberProfile.create(testMemberId, testEmptyMemberProfileImage, testMemberProfileIntroduction, testNormalUserNickname);
    }
}
