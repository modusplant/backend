...
public interface ProposalOrBugReportDashboardRecordTestUtils {
    ProposalOrBugReportDashboardRecord testProposalOrBugReportDashboardCheckedRecord =
            new ProposalOrBugReportDashboardRecord(
                    TEST_REPORT_ULID,
                    TEST_REPORT_TITLE,
                    TEST_REPORT_CONTENT,
