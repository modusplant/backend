...
public final class MemberConstant {
    ...
    public static final String MEMBER_BASIC_ADMIN_UUID_STRING = String.valueOf(MEMBER_BASIC_ADMIN_UUID);
    public static final String MEMBER_BASIC_ADMIN_NICKNAME = "관리자";
    public static final Role MEMBER_BASIC_ADMIN_ROLE = Role.ADMIN;
    ...
    public static final String MEMBER_BASIC_USER_UUID_STRING = String.valueOf(MEMBER_BASIC_USER_UUID);
    public static final String MEMBER_BASIC_USER_NICKNAME = "일반유저";
    public static final Role MEMBER_BASIC_USER_ROLE = Role.USER;
    ...
    public static final Role MEMBER_GOOGLE_USER_ROLE = Role.USER;
    ...
    public static final Role MEMBER_KAKAO_USER_ROLE = Role.USER;
