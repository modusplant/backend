...
public interface MemberNicknameUpdateRequestTestUtils {
    MemberProfileUpdateRequest TEST_MEMBER_NICKNAME_UPDATE_REQUEST = new MemberProfileUpdateRequest(MEMBER_PROFILE_BASIC_USER_INTRODUCTION, MEMBER_PROFILE_BASIC_USER_IMAGE_PATH, MEMBER_BASIC_USER_NICKNAME);
}
