package kr.modusplant.domains.member.common.util.framework.outbound.jpa.entity.record;
...
public interface FilenameAndSrcEntityRecordTestUtils {
    FilenameAndSrcEntityRecord testFilenameAndSrcEntityRecord1 =
            new FilenameAndSrcEntityRecord(TEST_REPORT_IMAGE_FILE_NAME_1_PNG, TEST_REPORT_PROPOSAL_OR_BUG_IMAGE_PATH_1);
    FilenameAndSrcEntityRecord testFilenameAndSrcEntityRecord2 =
            new FilenameAndSrcEntityRecord(TEST_REPORT_IMAGE_FILE_NAME_2_PNG, TEST_REPORT_PROPOSAL_OR_BUG_IMAGE_PATH_2);
    FilenameAndSrcEntityRecord testFilenameAndSrcEntityRecord3 =
            new FilenameAndSrcEntityRecord(TEST_REPORT_IMAGE_FILE_NAME_3_PNG, TEST_REPORT_PROPOSAL_OR_BUG_IMAGE_PATH_3);
