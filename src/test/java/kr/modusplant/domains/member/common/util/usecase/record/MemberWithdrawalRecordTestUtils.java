...
public interface MemberWithdrawalRecordTestUtils {
    MemberWithdrawalRecord testBasicMemberWithdrawalRecord = new MemberWithdrawalRecord(null, null, MEMBER_AUTH_BASIC_USER_ACCESS_TOKEN);
    MemberWithdrawalRecord testKakaoMemberWithdrawalRecord = new MemberWithdrawalRecord(TEST_SOCIAL_KAKAO_CODE, SocialProvider.KAKAO.getValue(), MEMBER_AUTH_BASIC_USER_ACCESS_TOKEN);
    MemberWithdrawalRecord testGoogleMemberWithdrawalRecord = new MemberWithdrawalRecord(TEST_SOCIAL_GOOGLE_CODE, SocialProvider.GOOGLE.getValue(), MEMBER_AUTH_BASIC_USER_ACCESS_TOKEN);
}
