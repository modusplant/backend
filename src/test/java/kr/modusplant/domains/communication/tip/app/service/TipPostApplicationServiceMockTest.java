...
class TipPostApplicationServiceMockTest implements SiteMemberEntityTestUtils, PlantGroupEntityTestUtils, TipPostEntityTestUtils {
    ...
    void countViewsShouldReturnRedisValueWhenRedisHasValueTest() {
        ...
        // when
        Long result = tipPostApplicationService.countViews(ulid);
    ...
    void countViewsShouldThrowExceptionWhenRedisIsEmptyAndDbEmptyTest() {
        ...
        assertThrows(EntityNotFoundWithUlidException.class,
                () -> tipPostApplicationService.countViews(ulid));
    }
    ...
    void increaseWhenLockExistsTest() {
        ...
        // when
        Long result = tipPostApplicationService.increase(ulid,memberUuid);
