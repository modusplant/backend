...
public class ConvCommentControllerTest implements
    ...
    void getByPostTest() throws Exception {
        ...
        // then
        mockMvc.perform(get("/api/crud/conv/comment/post/{ulid}", postEntity.getUlid()))
    ...
    void getByAuthMemberTest() throws Exception {
        ...
        // then
        mockMvc.perform(get("/api/crud/conv/comment/member/auth/{uuid}", memberEntity.getUuid()))
    ...
    void getByCreateMemberTest() throws Exception {
        ...
        // then
        mockMvc.perform(get("/api/crud/conv/comment/member/create/{uuid}", memberEntity.getUuid()))
    ...
    void getByContentTest() throws Exception {
        ...
        // then
        mockMvc.perform(get("/api/crud/conv/comment/content/{content}", commentResponse.content()))
    ...
    void getByPostAndPathTest() throws Exception {
        ...
        // then
        mockMvc.perform(get("/api/crud/conv/comment/post/{ulid}/path/{path}", postEntity.getUlid(), encodedPath))
    ...
    void insertConvCommentTest() throws Exception {
        ...
        // then
        mockMvc.perform(post("/api/crud/conv/comment", insertRequest)
    ...
    void removeConvCommentTest() throws Exception {
        ...
        // then
        mockMvc.perform(delete("/api/crud/conv/comment/{ulid}/{path}", postEntity.getUlid(), encodedPath))
