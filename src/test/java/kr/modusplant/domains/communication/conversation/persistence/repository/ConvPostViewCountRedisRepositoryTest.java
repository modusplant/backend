...
class ConvPostViewCountRedisRepositoryTest {
    @Mock
    ...
    void readShoudReturnLongWhenValueExistsTest() {
        ...
        // when
        Long result = convPostViewCountRedisRepository.read(ulid);
    ...
    void increaseTest() {
        ...
        // when
        Long result = convPostViewCountRedisRepository.increase(ulid);
    ...
    void writeTest() {
        ...
        // when
        convPostViewCountRedisRepository.write(ulid,20L);
    ...
    void findAllTest() {
        ...
        // when
        Map<String, Long> result = convPostViewCountRedisRepository.findAll();
