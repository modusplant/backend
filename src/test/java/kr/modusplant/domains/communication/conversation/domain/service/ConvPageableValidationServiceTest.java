...
class ConvPageableValidationServiceTest {

    private final ConvPageableValidationService pageableValidationService;
    private final ConvPostRepository postRepository;

    @Autowired
    ConvPageableValidationServiceTest(ConvPageableValidationService pageableValidationService, ConvPostRepository postRepository) {
