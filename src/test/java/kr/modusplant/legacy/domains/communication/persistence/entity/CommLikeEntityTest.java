...
public class CommLikeEntityTest implements CommLikeEntityTestUtils {
    ...
    void likeCommPost_success () {
        // when
        CommLikeEntity commLikeEntity = entityManager.find(CommLikeEntity.class, new CommLikeId(postId, memberId));
    ...
    void unlikeCommPost_success() {
        ...
        // then
        CommLikeEntity deletedEntity = entityManager.find(CommLikeEntity.class, new CommLikeId(postId, memberId));
