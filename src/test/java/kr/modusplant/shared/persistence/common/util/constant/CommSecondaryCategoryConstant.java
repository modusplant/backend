...
public final class CommSecondaryCategoryConstant {
    public static final Integer TEST_COMM_SECONDARY_CATEGORY_ID = 1;
    public static final List<Integer> TEST_COMM_SECONDARY_CATEGORIES_ID = List.of(TEST_COMM_SECONDARY_CATEGORY_ID);
