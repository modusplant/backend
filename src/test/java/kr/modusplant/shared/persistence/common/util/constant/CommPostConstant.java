...
public final class CommPostConstant {
    ...
    public static final List<String> TEST_COMM_POST_CONTENT_IMAGE_FILE_KEYS = List.of("/images/16e94f67-5abc-48d2-95a1-9cb4e78c7890.jpg");
    ...
    public static final String TEST_COMM_POST_CONTENT = """
            [
              {
                "type": "text",
                "filename": "text_0.txt",
    ...
    private static JsonNode createSampleContentAsJsonNode() {
        try {
            return objectMapper.readTree(TEST_COMM_POST_CONTENT);
        } catch (IOException e) {
