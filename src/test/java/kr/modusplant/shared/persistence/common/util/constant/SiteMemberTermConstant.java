...
public final class SiteMemberTermConstant {
    ...
    public static final String MEMBER_TERM_ADMIN_AGREED_AD_INFO_RECEIVING_VERSION = createVersion(3, 2, 104);
    ...
    public static final String MEMBER_TERM_USER_AGREED_AD_INFO_RECEIVING_VERSION = createVersion(3, 3, 104);
}