...
public interface ProposalOrBugReportEventTestUtils {
    ProposalOrBugReportEvent testProposalOrBugReportEvent = ProposalOrBugReportEvent.create(MEMBER_BASIC_USER_UUID, TEST_REPORT_TITLE, TEST_REPORT_CATEGORY_PROPOSAL, TEST_REPORT_CONTENT, TEST_REPORT_IMAGE_PATH);
}
