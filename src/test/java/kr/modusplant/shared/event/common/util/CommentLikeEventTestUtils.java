...
public interface CommentLikeEventTestUtils {
    CommentLikeEvent testCommentLikeEvent = CommentLikeEvent.create(MEMBER_BASIC_USER_UUID, TEST_COMM_POST_ULID, TEST_COMM_COMMENT_PATH);
}
