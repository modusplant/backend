    ...
    class CreateTest {
        ...
        void testCreate_givenNullMemberId_willThrowException() {
            ...
            InvalidValueException invalidValueException = assertThrows(InvalidValueException.class, () ->
                    CommentLikeEvent.create(null, TEST_COMM_POST_ULID, TEST_COMM_COMMENT_PATH));
        ...
        void testCreate_givenEmptyPostUlid_willThrowException() {
            // given & when
            InvalidValueException invalidValueException = assertThrows(InvalidValueException.class, () ->
                    CommentLikeEvent.create(MEMBER_BASIC_USER_UUID, "", TEST_COMM_COMMENT_PATH));
        ...
        void testCreate_givenEmptyPath_willThrowException() {
            // given & when
            InvalidValueException invalidValueException = assertThrows(InvalidValueException.class, () ->
                    CommentLikeEvent.create(MEMBER_BASIC_USER_UUID, TEST_COMM_POST_ULID, ""));
