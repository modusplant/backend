...
class PrimaryCategoryJpaRepositoryTest implements PrimaryCategoryEntityTestUtils {

    private final PrimaryCategoryJpaRepository commCategoryRepository;

    @Autowired
    PrimaryCategoryJpaRepositoryTest(PrimaryCategoryJpaRepository commCategoryRepository) {
    ...
    void findByUuidTest() {
        // given & when
        PrimaryCategoryEntity entity = commCategoryRepository.save(createPrimaryCategoryEntity());
