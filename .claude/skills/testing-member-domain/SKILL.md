...
- **Target Paths:** (Only look up if needed for testing)
  ...
  - @src/test/java/kr/modusplant/domains/member/domain/vo (including `vo/nullobject`)
  ...
  - @src/test/java/kr/modusplant/domains/member/usecase/model/read
...
- **Target Paths:** (Only look up if needed for testing)
  ...
  - @src/test/java/kr/modusplant/domains/member/domain/entity (including `entity/nullobject`)
